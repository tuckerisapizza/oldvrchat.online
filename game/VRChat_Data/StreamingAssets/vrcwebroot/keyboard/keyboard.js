...
(function() {
  ...
  VKI_Keyboard_Global = this;

  this.VKI_version = "1.49";
  this.VKI_showVersion = false;
  this.VKI_target = false;
  this.VKI_inputElem = null;
            ...
            for (var y = 0, lkey; lkey = lyt[y++];) {
              var td = document.createElement('td');
                ...
                switch (lkey[1]) {
                  ...
                  case "Enter":
                    VKI_addListener(td, 'click', function() {
                          // instead of submitting form, we call back to COHERENTUI with the form value
                          engine.call('AcceptKeyInput', self.VKI_inputElem.value);
                          return true;
                      /*
